...
OUTDIR = '/home/hrisim/ros_ws/src/HRISim/postprocessing/hrisim_postprocess/csv_pp-1/'
...
for bag in BAGNAME:
    ...
    df_sub.rename(columns={'TOD': 'S', 'R_WP': 'W', 'R_V': 'V', 'R_B': 'B', 'OBS': 'O', 'PD_WP': 'D', 'BC': 'L'}, inplace=True)
    general_columns_name = ['S', 'W', 'V', 'B', 'L', 'O', 'D', 'DIST']
