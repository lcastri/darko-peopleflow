...
class TwistMuxNode:
    def __init__(self):
        ...
        rospy.Subscriber('mobile_base_controller/tmp_cmd_vel', Twist, self.cb_tmp_cmd_vel)
        rospy.Subscriber('twist_mux/scaling_factor', Float32, self.cb_scaling_factor)
        
        # Publisher for twist_mux/cmd_vel
        self.cmd_vel_pub = rospy.Publisher('mobile_base_controller/cmd_vel', Twist, queue_size=10)

    def cb_tmp_cmd_vel(self, msg:Twist):
        tmp_cmd_vel = msg
    ...
    def cb_scaling_factor(self, msg):
